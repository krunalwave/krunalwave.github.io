...
/**
 * Converting byte[] to int is suitable for byte[] with low-end first and high-end last. Python3's in.from_bytes(byte[], 'little')
...
* @param {Number} count The number of users supported by the license
* @param {Number} majorVersion The major version number, such as 21.0 is 21
* @param {Number} minorVersion minor version number. For example, 21.0 is 0
*/
